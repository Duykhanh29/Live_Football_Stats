...
class AppColors {
  ...
  static Color lighterCardColor = Color.fromARGB(255, 179, 255, 251);
  static Color homeWinColor = Colors.red;
  static Color drawColor = Colors.blue;
  static Color awayWinColor = Colors.yellow;
