...
class GroupTableWidget extends StatefulWidget {
  GroupTableWidget({super.key, required this.groupStandingEntities});
  GroupStandingEntities groupStandingEntities;
...
class _GroupTableWidgetState extends State<GroupTableWidget> {
  ...
  void initState() {
    ...
    super.initState();
    standingsDataSource =
        StandingsDataSource(list: widget.groupStandingEntities.standings);
  }
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(
                widget.groupStandingEntities.groupName,
